...
/*======================== buf size config ================================*/	
#define MAX_DTC_NUMBER 				35//锟斤拷锟紻TC锟斤拷锟斤拷
#define MAX_DID_NUMBER 				70//锟斤拷锟紻ID锟斤拷锟斤拷
#define MAX_SNAPSHOT_NUMBER 			10//锟斤拷锟斤拷锟斤拷锟斤拷息锟斤拷锟斤拷
#define MAX_GROUP_NUMBER				5//锟斤拷锟紻TC锟斤拷锟斤拷锟�
/*======================== buf size config ================================*/	
